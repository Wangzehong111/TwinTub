...
public enum TwinTubEventType: String, Codable, CaseIterable, Sendable {
...
public struct TwinTubEvent: Codable, Equatable, Sendable {
    public let event: TwinTubEventType
...
extension JSONDecoder {
    static let twinTubEventDecoder: JSONDecoder = {
