...
final class NotificationServiceTests: XCTestCase {
    ...
    func testPostWaitingSendsCorrectContent() {
        ...
        XCTAssertEqual(mock.records[0].title, "TwinTub Waiting")
    ...
    func testPostWaitingEscalated() {
        ...
        XCTAssertEqual(mock.records[0].title, "TwinTub Escalation")
    }
    ...
    func testPostCompletedSendsCorrectContent() {
        ...
        XCTAssertEqual(mock.records.count, 1)
        XCTAssertEqual(mock.records[0].title, "TwinTub Done")
    }
    ...
    func testPostTerminatedSendsCorrectContent() {
        ...
        XCTAssertEqual(mock.records.count, 1)
        XCTAssertEqual(mock.records[0].title, "TwinTub Session Ended")
